//MÉTODO: findindex()
//Funç~]ao: Retorna a POSIÇÃO (íNDICE 0, 1, 2...) do primeiro item que atende à condição. Se não encontrar, retorna -1.
...
//Exemplo 2 (Intermediário: Localizar podição de usuário por ID
...
function deletarProdutoPorId(id) {
    ...
    return{
        status: 200,
        mensagem: `Produto `${removido.nome}` remove com sucesso!`,
