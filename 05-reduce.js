...
//EXEMPLO 1 (Básico): Somatória de valores númericos
console.log("--- Exemplo 1: Soma de números (Basico) ---");
...
const pedido = [
    {id: 1, nome: "Hambúrquer Artesanal", preco: 32.0, qtd: 2},
...
//Calcula o valor dos itens meltiplicando o preco unitário pela quantidade
